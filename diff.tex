...
%DIF DEL /dir/cag-template_old.tex   Fri Dec  2 01:03:34 2022
%DIF ADD /dir/cag-template.tex       Fri Dec  2 01:03:34 2022
%% 
...
%     } 
%     \caption{\DIFaddFL{Comparison of isotropic and anisotropic fluid particles.}}
%     \label{fig:figure3}
% \end{figure}
\begin{figure}[htbp]
    ...
    \centering
    \subfigure[isotropic] {
    \includegraphics[width=0.46\linewidth]{figs/isotropic.png}
    }    
    \subfigure[anisotropic] {
    \includegraphics[width=0.46\linewidth]{figs/anisotropic.png}
    } 
    \caption{Comparison of isotropic and anisotropic fluid particles.}
    \label{fig:figure3}
\end{figure}

\DIFaddend \paragraph{Smoothing Depth Information}
...
\DIFaddbegin \begin{figure}[b!]
    ...
    \centering
    \subfigure[isotropic] {
    \includegraphics[width=0.47\linewidth]{figs/figure5_1_new.png}
    }
    \DIFaddFL{\hspace{-7pt}
    }\subfigure[anisotropic] {
    \includegraphics[width=0.47\linewidth]{figs/figure5_2_new.png}
    } 
